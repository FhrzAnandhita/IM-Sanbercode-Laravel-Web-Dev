...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Kata kedua: " . substr($string2, 2, 4); // Mengambil "love" (mulai indeks 2, sepanjang 4 karakter)
        echo "<br> Kata Ketiga: " . substr($string2, 7, 3); // Mengambil "PHP" (mulai indeks 7, sepanjang 3 karakter)
